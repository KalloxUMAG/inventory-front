      ...
      <q-card class="my-card" flat bordered>
        ...
        <q-card-section horizontal>
          <q-card-section class="col-4">
            ...
            <div class="row q-mb-xs">
              ...
              <div class="col field-content q-ml-xs">
                Cada {{ this.equipment.maintenance_period }} días
              </div>
            </div>
            <div class="row q-mb-xs">
              <div class="col-5 field-label text-right q-mr-md">
        ...
        <q-card-section horizontal>
          <q-card-section class="col-7">
            <NoRedirectTable
              v-if="this.maintenances != null"
              title="Mantenciones"
              :columns="this.columns_maintenances"
          ...
          <q-card-section class="col-5">
            <RenderTable
              ...
              title="Proyectos"
              :columns="this.columns_projects"
              :rows="this.projects"
              detail_query="/projects/"
            />
          </q-card-section>
        </q-card-section>
      </q-card>
...
export default {
  ...
  methods: {
    getEquipment() {
      axios
        .get(this.query_equipment)
        .then((response) => (this.equipment = response.data));
    },
    getMaintenances() {
      axios
        .get(this.query_maintenances)
        .then((response) => (this.maintenances = response.data));
    },
    getProjects() {
      axios
